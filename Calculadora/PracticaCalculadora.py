...
boton8=Button(miFrame,text="8",wid=3,command=lambda:numeroPulsado("8"))
boton8.grid(row=2,column=2)
boton9=Button(miFrame,text="9",wid=3,command=lambda:numeroPulsado("9"))
...
#-----Fila 3-------------
boton1=Button(miFrame,text="1",wid=3,command=lambda:numeroPulsado("1"))
boton1.grid(row=4,column=1)
boton2=Button(miFrame,text="2",wid=3,command=lambda:numeroPulsado("2"))
boton2.grid(row=4,column=2)
boton3=Button(miFrame,text="3",wid=3,command=lambda:numeroPulsado("3"))
boton3.grid(row=4,column=3)
botonRest=Button(miFrame,text="-",wid=3)
botonRest.grid(row=4,column=4)

#-----Fila 4-------------
boton0=Button(miFrame,text="0",wid=3,command=lambda:numeroPulsado("0"))
